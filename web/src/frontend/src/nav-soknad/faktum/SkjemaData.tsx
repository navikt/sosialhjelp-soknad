...
import { lagreFaktum, setFaktum, setFaktumIgnorert } from "../redux/fakta/faktaActions";
import {
...
import { finnFaktum, getFaktumVerdi, getPropertyVerdi, oppdaterFaktumMedVerdier } from "../utils";
import { validerFaktum } from "../validering/utils";
import { FaktumValideringFunc, FaktumValideringsregler, Valideringsfeil } from "../validering/types";
...
class SkjemaData extends React.Component<Props, {}> {
	...
	componentWillReceiveProps(nextProps: any) {
		const ignorert = (nextProps as Props).ignorert;
