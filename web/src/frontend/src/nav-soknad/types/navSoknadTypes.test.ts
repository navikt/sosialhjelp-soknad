...
const soknad: Soknad = {
	...
	fakta: [
		...
		},
		{
			...
			soknadId: 1,
			parrentFaktum: 19,
			key: "inntekt.bankinnskudd.true.type.livsforsikringssparedel",
			value: null,
			faktumEgenskaper: [],
			properties: {},
			type: "BRUKERREGISTRERT"
		},
		{
			...
			soknadId: 1,
			parrentFaktum: 19,
			key: "inntekt.bankinnskudd.true.type.verdipapirer",
			value: null,
			faktumEgenskaper: [],
			properties: {},
			type: "BRUKERREGISTRERT"
		},
		{
			...
			soknadId: 1,
			parrentFaktum: 19,
			key: "inntekt.bankinnskudd.true.type.belop",
			value: null,
			faktumEgenskaper: [],
			properties: {},
			type: "BRUKERREGISTRERT"
		},
		{
			...
			soknadId: 1,
			parrentFaktum: 59,
			key: "inntekt.bankinnskudd.true.type.belop.true.beskrivelse",
			value: null,
			faktumEgenskaper: [],
			properties: {},
			type: "BRUKERREGISTRERT"
		...
		},
		{
			...
			soknadId: 1,
			parrentFaktum: 61,
			key: "inntekt.inntekter.true.type.forsikring",
			value: null,
			faktumEgenskaper: [],
			properties: {},
			type: "BRUKERREGISTRERT"
		},
		{
			...
			soknadId: 1,
			parrentFaktum: 61,
			key: "inntekt.inntekter.true.type.annen",
			value: null,
			faktumEgenskaper: [],
			properties: {},
			type: "BRUKERREGISTRERT"
		},
		{
			...
			soknadId: 1,
			parrentFaktum: 66,
			key: "inntekt.inntekter.true.type.annen.true.beskrivelse",
			value: null,
			faktumEgenskaper: [],
			properties: {},
			type: "BRUKERREGISTRERT"
		...
		},
		{
			...
			soknadId: 1,
			parrentFaktum: 68,
			key: "utgifter.boutgift.true.type.kommunalAvgift",
			value: null,
			faktumEgenskaper: [],
			properties: {},
			type: "BRUKERREGISTRERT"
		...
		},
		{
			...
			soknadId: 1,
			parrentFaktum: 68,
			key: "utgifter.boutgift.true.type.annenBoutgift",
			value: null,
			faktumEgenskaper: [],
			properties: {},
			type: "BRUKERREGISTRERT"
		},
		{
			...
			soknadId: 1,
			parrentFaktum: 74,
			key: "utgifter.boutgift.true.type.annenBoutgift.true.beskrivelse",
			value: null,
			faktumEgenskaper: [],
			properties: {},
			type: "BRUKERREGISTRERT"
		...
		},
		{
			...
			soknadId: 1,
			parrentFaktum: 76,
			key: "utgifter.barn.true.utgifter.barnFritidsaktiviteter",
			value: null,
			faktumEgenskaper: [],
			properties: {},
			type: "BRUKERREGISTRERT"
		...
		},
		{
			...
			soknadId: 1,
			parrentFaktum: 76,
			key: "utgifter.barn.true.utgifter.barnTannregulering",
			value: null,
			faktumEgenskaper: [],
			properties: {},
			type: "BRUKERREGISTRERT"
		...
		},
		{
			...
			soknadId: 1,
			parrentFaktum: 76,
			key: "utgifter.barn.true.utgifter.annenBarneutgift",
			value: null,
			faktumEgenskaper: [],
			properties: {},
			type: "BRUKERREGISTRERT"
		},
		{
			...
			soknadId: 1,
			parrentFaktum: 81,
			key: "utgifter.barn.true.utgifter.annenBarneutgift.true.beskrivelse",
			value: null,
			faktumEgenskaper: [],
			properties: {},
			type: "BRUKERREGISTRERT"
...
describe("soknad types", () => {
	it("should have types checked", () => {
		function prosesserSoknad(s: Soknad) {
			return s;
		}
