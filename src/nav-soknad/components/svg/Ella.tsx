    ...
    return (
        ...
        >
            <defs>
                ...
                <path
                    fill="#FFF"
                    d="M101.6 145.4h-1.2l-1.3 3.15h1.2l1.3-3.15z"
                    id="g"
                />
                <path
                    fill="#FFF"
                    d="M116.85 145.4h-.75l-1.25 3.15h.75l1.25-3.15z"
                    id="h"
                />
                <path
                    fill="#FFF"
                    d="M118.95 145.4h-.35l-1.25 3.15h.3l1.3-3.15z"
                    id="i"
                />
                <path
                    fill="#C52D35"
                ...
                <path
                    fill="#C52D35"
                    d="M107.1 147.4h-.25l-.8 1.15h.65q.1 0 .1-.15l.4-.9-.1-.1z"
                    id="m"
                />
                <path
                    fill="#C52D35"
                    d="M112.55 145.4l-.1.05-1 3.1h1.05l.05-.05 1.2-3q.1-.1-.05-.1h-1.15z"
                    id="n"
                />
                <path
                    fill="#C52D35"
                    d="M111.25 145.5q0-.1-.15-.1h-1.6q-.1 0 .5.2l1.15 2.85.15.1h.95l-1-3.05z"
                    id="o"
                />
                <path
                    fill="#C52D35"
                ...
                <path
                    fill="#C2B5CF"
                    d="M107.65 134.3v4.1h1.55v-4.1h-1.55z"
                    id="r"
                />
                <path
                    fill="#E7E5E2"
