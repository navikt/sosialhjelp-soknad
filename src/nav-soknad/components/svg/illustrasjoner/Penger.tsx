        ...
        <>
            <svg aria-hidden="true" width={100} height={100} className="kun_desktop">
                ...
                <g fill="none" fillRule="evenodd">
                    ...
                    <path fill="#E3B0A8" d="M62 35h8v29h-8zm-34 2h2v5h-2zm3 0h4v5h-4zm5 0h4v5h-4z" />
                    <g transform="translate(28 54)">
                        <path fill="#FFA733" d="M13 9h11v2H13zm-1-2h11v2H12zM0 9h11v2H0zm13-4h11v2H13zm1-2h11v2H14z" />
            ...
            <svg aria-hidden="true" width={80} height={80} className="kun_mobil">
                ...
                <g fill="none" fillRule="evenodd">
                    ...
                    <path fill="#E3B0A8" d="M50 28h6v23h-6zm-28 2h2v4h-2zm3 0h3v4h-3zm4 0h3v4h-3z" />
