...
const ErrorCanary = () => {
    useTimeoutFn(
        () => getLogger().error("ClientSideIntl ErrorCanary: Messages still not loaded after 3 seconds"),
        3000
    );
...
/**
 * Provider-komponent for klientside i18n og logging, til de sidene hvor serverside i18n ikke er tilgjengelig.
 */
export const ClientSideProvider = ({children}: {children: ReactNode}) => {
    ...
    useEffect(() => {
        ...
        import(`../../../../messages/${locale}.json`)
            ...
            .catch((e) => getLogger().error(e, "ClientSideIntl: Failed to load messages"));
    }, [locale]);
