...
import {BodyShort, Button, FileObject, FileUpload, Heading, Label, VStack} from "@navikt/ds-react";
...
/**
 * Delt kjerne for opplasting av dokumentasjon.
 *
 * Brukes av `NewDokumenter` (standard søknad) og `KortDokumenter` (kort søknad).
...
export const VedleggUpload = ({
    ...
    // Aksels Dropzone kobler selv knappen til label/description. På mobil finnes ingen
    // dropzone, så koblingen må settes opp manuelt her.
            ...
            <VStack gap="space-24">
                ...
                {isMobile && (
                    <VStack gap="space-8" align="start">
                        ...
                        >
                            <Button
                                aria-describedby={mobileDescribedBy}
                                variant="secondary"
