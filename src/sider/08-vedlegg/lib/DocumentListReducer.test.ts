...
const DOCUMENT_TYPE: DokumentasjonDtoType = {value: "FORMUE_BRUKSKONTO", type: "FormueType"};
const OTHER_DOCUMENT_TYPE: DokumentasjonDtoType = {value: "JOBB", type: "InntektType"};
...
describe("initialDocumentListState", () => {
    it("should initialize with the given dokumentasjonType and an empty documents array", () => {
        const state = initialDocumentListState(DOCUMENT_TYPE.value);
...
describe("DocumentListReducer", () => {
    ...
    beforeEach(() => {
        initialState = initialDocumentListState(DOCUMENT_TYPE.value);
    });
