...
import {lastOppEttersendelseVedlegg, slettEttersendtVedlegg} from "../../lib/redux/ettersendelse/ettersendelseActions";
import {REST_FEIL, REST_STATUS} from "../../lib/redux/restTypes";
...
export const EttersendelseVedlegg = ({vedlegg, ettersendelseAktivert, feilKode}: Props) => {
