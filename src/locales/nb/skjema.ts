export const skjema = {
    ...
    familierelasjon: {
        ...
        ingress_antallBarn: {
            entall: "{{antallBarn}} barn under 18 år",
            stringValue: "{{antallBarn}} barn under 18 år",
        },
    ...
    validering: {
        ...
        soknadsmottaker: {
            feilmelding: "Du må velge en gyldig adresse før du kan gå videre",
        },
