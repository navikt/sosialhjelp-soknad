...
import Behov from "./sider/kort/03-behov";
import ArbeidOgFamilie from "./sider/kort/02-arbeid-og-familie";
                                ...
                                <Route path={"skjema"}>
                                    <Route path="kort/:behandlingsId">
                                        <Route element={<SwitchSoknadType />}>
                                            <Route path="2" element={<ArbeidOgFamilie />} />
                                            <Route path="3" element={<Behov />} />
