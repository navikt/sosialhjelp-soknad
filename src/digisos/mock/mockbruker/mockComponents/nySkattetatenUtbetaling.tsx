...
interface Props {
    onLeggTilNyUtbetaling: (
        maned: string,
        orgNummer: number,
        utbetaling: NySkattetatenInntektObject,
        trekk: NySkattetatenForskuddstrekkObject | undefined
    ) => void;
}
...
export class NySkattetatenUtbetaling extends React.Component<Props, State> {
    ...
    lagreNyUtbetaling() {
        ...
        this.props.onLeggTilNyUtbetaling(
            this.state.utbetalingsmaned,
            this.state.orgNummer,
            nyInntekt,
            nyForskuddstrekk
        );
                        ...
                        <div className="mock-newThing-body">
                            ...
                            >
                                {manederList.map((maaned: string) => {
                                    return (
                                        <option value={maaned} key={maaned}>
                                            {maaned}
                                        </option>
                                    );
                                })}
