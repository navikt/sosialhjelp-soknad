...
} from "../../skjema/familie/sivilstatus/FamilieTypes";
...
import {
	...
	Utbetalinger
} from "../../skjema/inntektFormue/utbetalinger/utbetalingerTypes";
import {
	initialVerdierState,
	Verdier
} from "../../skjema/inntektFormue/verdier/VerdierTypes";
import {
	initialFormueState,
	Formue
} from "../../skjema/inntektFormue/formue/FormueTypes";
import {
	initialBoutgifterState,
	Boutgifter
} from "../../skjema/utgifterGjeld/boutgifter/BoutgifterTypes";
import {
	initialBarneutgifterState,
	Barneutgifter
} from "../../skjema/utgifterGjeld/barneutgifter/BarneutgifterTypes";
import {
	AdresseKategori,
	Adresser,
