            ...
            <div role="alert" aria-live="assertive">
                <div className="skjemaelement__feilmelding">
                    {filopplasting.feilKode &&
                        filopplasting.opplysningtype === props.opplysning.type &&
                        filopplasting.feilKode !== REST_FEIL.SAMLET_VEDLEGG_STORRELSE_FOR_STOR && (
                            <FormattedMessage id={filopplasting.feilKode} />
                        )}
                    {filopplasting.feilKode &&
                        filopplasting.opplysningtype === props.opplysning.type &&
                        filopplasting.feilKode === REST_FEIL.SAMLET_VEDLEGG_STORRELSE_FOR_STOR && (
                            <FormattedMessage id={filopplasting.feilKode} values={{antall: antallFiler}} />
                        )}
                </div>
            </div>
        </div>
